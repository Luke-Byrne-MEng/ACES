...
int main(int argc, char **argv)
{
  ...
  ros::Subscriber sub_imu = n.subscribe("/jet/imu", 1000, &ImuGrabber::GrabImu, &imugb); 
  ros::Subscriber sub_img0 = n.subscribe("/jet/camera/image_raw", 100, &ImageGrabber::GrabImage,&igb);
